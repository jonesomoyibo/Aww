...
import com.capiter.android.posts_list.ui.adapter.AllPostListAdapter
import com.capiter.android.posts_list.ui.model.PostItemMapper
import com.capiter.android.posts_list.ui.paging.PostPageDataSource
...
class AllPostListModule (
    ...
    /**
     * Create a provider method binding for [PostListViewModel].
     *
    ...
    /**
     * Create a provider method binding for [PostsPageDataSource].
     *
    ...
    /**
     * Create a provider method binding for [PostItemMapper].
     *
