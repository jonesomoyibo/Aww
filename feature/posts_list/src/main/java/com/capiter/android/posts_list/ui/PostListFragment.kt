...
import com.capiter.android.posts_list.ui.adapter.AllPostListAdapterState
...
import posts_list.R
import posts_list.databinding.FragmentPostsListBinding
...
class PostListFragment : BaseFragment<FragmentPostsListBinding, PostListViewModel>
    ...
    /**
     * Observer view event change on [PostsListViewModel].
     *
     * @param viewEvent Event on posts list.
     */
